...
class ListasInspeccionController extends Controller
{
    ...
    private function processListaTemplates($data, ServicioAnexo $servicio)
    {
        ...
        $usuario = User::where('id', $servicio->id_usuario)->first();
        $templatePaths = [
        ...
        foreach ($templatePaths as $templatePath) {
            ...
            foreach ($data as $key => $value) {
                $templateProcessor->setValue('nomenclatura', $servicio->nomenclatura);
                $templateProcessor->setValue('fecha_revision', $fechaInspeccion);
                $templateProcessor->setValue('nombre_inspector', $usuario->name);
