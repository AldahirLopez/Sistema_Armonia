        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color: #ffbf539e;color: #ffffff;">
                <h5 class="modal-title" id="generarServicioModalLabel">
                    <i class="bi bi-pencil-square me-2"></i>Generar Servicio 005
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- Formulario de generación de expediente -->
                <form id="generarServicioForm" action="{{ route('servicio_005.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
