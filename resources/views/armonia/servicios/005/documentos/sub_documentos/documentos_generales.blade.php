                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($docExists)
                                    <form action="{{ route('documentacion_servicio_005.general.delete', $documentId) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('documentacion_servicio_005.general.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="mb-3">
