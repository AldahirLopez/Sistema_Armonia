        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-4">
                    <form action="{{ route('armonia.servicios.005.documentos.menu') }}" method="GET">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($docExists)
                                    <form action="{{ route('documentacion_servicio_005.informatica.delete', $documentId) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('documentacion_servicio_005.informatica.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="mb-3">
