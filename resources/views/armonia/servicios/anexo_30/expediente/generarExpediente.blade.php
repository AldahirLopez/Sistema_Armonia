...
<section class="section">
    ...
    <div class="section-body">
        <div class="row">
            ...
            <!-- Mostrar las siguientes tarjetas solo si el expediente ha sido generado -->
            @if(count($existingFiles) > 0) <!-- Verificar si existen archivos relacionados al expediente -->
            <!-- Mostrar las tarjetas de Dictámenes y Reporte Fotográfico -->
            <div class="col-md-4 mb-4">
