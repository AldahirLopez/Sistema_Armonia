                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="requerimientos_especificos_estaciones_servicio_gasolinas" value="si" disabled> Sí
                                </label>
                                <label>
                                    <input type="radio" name="requerimientos_especificos_estaciones_servicio_gasolinas" value="no" disabled> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="requerimientos_especificos_estaciones_servicio_gasolinas" value="no_aplica" checked> No Aplica
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <strong>No Aplica por ser una planta de almacenamiento y distribución</strong>
                                <input type="hidden" name="observaciones_requerimientos_especificos_estaciones_servicio_gasolinas" value="No aplica por ser una planta de almacenamiento y distribución">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <strong>No Aplica por ser una planta de almacenamiento y distribución</strong>
                                <input type="hidden" name="observaciones_requerimientos_especificos_estaciones_servicio_gas_licuado_petroleo" value="No aplica por ser una planta de almacenamiento y distribución">
                            </td>
                        </tr>
