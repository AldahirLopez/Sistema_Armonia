                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <input type="hidden" name="observaciones50" class="form-control" value="No Aplica por ser una planta de almacenamiento y distribución">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <strong>No Aplica por ser una planta de almacenamiento y distribución</strong>
                                <input type="hidden" name="observaciones51" class="form-control" value="No Aplica por ser una planta de almacenamiento y distribución">
                            </td>
                        </tr>
