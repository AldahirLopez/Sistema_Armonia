                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="opcion24" value="si" disabled> Sí
                                </label>
                                <label>
                                    <input type="radio" name="opcion24" value="no" disabled> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="opcion24" value="no_aplica" checked> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <strong>No Aplica por ser una estación de servicio</strong>
                                <input type="hidden" name="observaciones24" class="form-control" value="No Aplica por ser una estación de servicio">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <strong>No Aplica por ser una estación de servicio</strong>
                                <input type="hidden" name="observaciones25" class="form-control" value="No Aplica por ser una estación de servicio">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="opcion26" value="si" disabled> Sí
                                </label>
                                <label>
                                    <input type="radio" name="opcion26" value="no" disabled> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="opcion26" value="no_aplica" checked> No Aplica
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <strong>No Aplica por ser una estación de servicio</strong>
                                <input type="hidden" name="observaciones26" class="form-control" value="No Aplica por ser una estación de servicio">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <strong>No Aplica por ser una estación de servicio</strong>
                                <input type="hidden" name="observaciones27" class="form-control" value="No Aplica por ser una estación de servicio">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <strong>No Aplica por ser una estación de servicio</strong>
                                <input type="hidden" name="observaciones28" class="form-control" value="No Aplica por ser una estación de servicio">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="opcion29" value="si" disabled> Sí
                                </label>
                                <label>
                                    <input type="radio" name="opcion29" value="no" disabled> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="opcion29" value="no_aplica" checked> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <strong>No Aplica por ser una estación de servicio</strong>
                                <input type="hidden" name="observaciones29" class="form-control" value="No Aplica por ser una estación de servicio">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <strong>No Aplica por ser una estación de servicio</strong>
                                <input type="hidden" name="observaciones30" class="form-control"  value="No Aplica por ser una estación de servicio">
                            </td>
                        </tr>
