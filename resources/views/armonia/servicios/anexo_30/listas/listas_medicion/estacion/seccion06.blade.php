                ...
                <table class="table table-bordered mb-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="hidrocarburos_medidos_medios_ductos" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="hidrocarburos_medidos_medios_ductos" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="hidrocarburos_medidos_medios_ductos" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_hidrocarburos_medidos_medios_ductos" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="registros_volumen_entrega_recepcion_transporte_transporte" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="registros_volumen_entrega_recepcion_transporte_transporte" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="registros_volumen_entrega_recepcion_transporte_transporte" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_registros_volumen_entrega_recepcion_transporte_transporte" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="sistemas_medicion_dinamica_ductos_trasnporte_distribucion" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="sistemas_medicion_dinamica_ductos_trasnporte_distribucion" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="sistemas_medicion_dinamica_ductos_trasnporte_distribucion" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_sistemas_medicion_dinamica_ductos_trasnporte_distribucion" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="tanques_indicador_liquido_manual_automatico" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="tanques_indicador_liquido_manual_automatico" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="tanques_indicador_liquido_manual_automatico" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_tanques_indicador_liquido_manual_automatico" class="form-control">
                            </td>
                        </tr>
