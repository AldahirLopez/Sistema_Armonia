                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="requerimientos_especificos_estaciones_servicio_gasolinas" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="requerimientos_especificos_estaciones_servicio_gasolinas" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="requerimientos_especificos_estaciones_servicio_gasolinas" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <strong>No Aplica por el tipo de instalación</strong>
                                <input type="hidden" name="observaciones_requerimientos_especificos_estaciones_servicio_gasolinas" class="form-control" value="No aplica por el tipo de instalación">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <strong>No Aplica por el tipo de instalación</strong>
                                <input type="hidden" name="observaciones_requerimientos_especificos_estaciones_servicio_gas_licuado_petroleo" class="form-control" value="No aplica por el tipo de instalación">
                            </td>
                        </tr>
