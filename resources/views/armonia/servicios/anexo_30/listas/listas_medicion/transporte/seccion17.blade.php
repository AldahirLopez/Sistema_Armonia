                ...
                <table class="table table-bordered mb-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="elemento_primario_almacenamiento_similares" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="elemento_primario_almacenamiento_similares" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="elemento_primario_almacenamiento_similares" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_elemento_primario_almacenamiento_similares" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="elemento_primario_marcas_volumetricas" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="elemento_primario_marcas_volumetricas" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="elemento_primario_marcas_volumetricas" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_elemento_primario_marcas_volumetricas" class="form-control">
                            </td>
                        </tr>
