                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <input type="hidden" name="observaciones38" class="form-control" value="No aplica por el tipo de instalación">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <strong>No Aplica por el tipo de instalación</strong>
                                <input type="hidden" name="observaciones39" class="form-control" value="No aplica por el tipo de instalación">
                            </td>
                        </tr>
