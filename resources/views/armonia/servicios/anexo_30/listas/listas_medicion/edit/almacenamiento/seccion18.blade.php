                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <input type="hidden" name="observaciones86" class="form-control" value="No Aplica por ser una planta de almacenamiento y distribución">
                            </td>
                        </tr>

                        <tr>
                            <td class="align-middle">
                            Además de lo establecido en la fracción I anterior, los sistemas de medición
                            dinámica deben cumplir con los siguientes requerimientos:  
                            </td>
                        </tr>
