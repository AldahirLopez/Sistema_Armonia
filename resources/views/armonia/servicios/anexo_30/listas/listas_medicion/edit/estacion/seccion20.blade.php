                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <input type="hidden" name="observaciones99" class="form-control" value="No Aplica por ser una estación de servicio">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <strong>No Aplica por ser una estación de servicio</strong>
                                <input type="hidden" name="observaciones100" class="form-control" value="No Aplica por ser una estación de servicio">
                            </td>
                        </tr>
