                ...
                <table class="table table-bordered mb-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_hidrocarburos" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="punto_medicion_hidrocarburos" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_hidrocarburos" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_punto_medicion_hidrocarburos" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_gas_condesados" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="punto_medicion_gas_condesados" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_gas_condesados" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_punto_medicion_gas_condesados" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_petroleo_estaciones" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="punto_medicion_petroleo_estaciones" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_petroleo_estaciones" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_punto_medicion_petroleo_estaciones" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_gas_condesados_RMF" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="punto_medicion_gas_condesados_RMF" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_gas_condesados_RMF" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_punto_medicion_gas_condesados_RMF" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_turbosina" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="punto_medicion_turbosina" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_turbosina" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_punto_medicion_turbosina" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_licuado_petroleo" value="si"> Sí
                                </label>
                                <label>
                                    <input type="radio" name="punto_medicion_licuado_petroleo" value="no"> No
                                </label>
                            </td>
                            <td class="text-center align-middle">
                                <label>
                                    <input type="radio" name="punto_medicion_licuado_petroleo" value="no_aplica"> No Aplica
                                </label>
                            </td>
                            <td class="align-middle">
                                <input type="text" name="observaciones_punto_medicion_licuado_petroleo" class="form-control">
                            </td>
                        </tr>
